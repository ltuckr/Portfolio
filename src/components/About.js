    ...
    <section className="bg-secondary text-white px-5 py-32" id="about">
      <div className="container mx-auto grid md:grid-cols-2 items-center justify-center md:justify-between">
        <div className="about-info">
          <h2 className="text-4xl font-bold mb-5 border-b-[5px] w-[180px] border-orange-300 pb-2">
            About Me
          </h2>

          <p className="pb-5">
            I'm a Fullstack Developer with a passion for visual beauty. 
          ...
          <p className="pb-5">
            ...
            Tailwind CSS and others, and my interest base expands all the time.
            In backend I've learned Node.js, Express.js, MongoDB, and Mongoose.
          </p>
          <p>
            When I'm not coding, I'm taking pictures, gaming, hiking in search of a waterfall or snuggling one of my furkids. 
