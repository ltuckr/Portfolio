  ...
  const projects = [
    {
      ...
      desc: "An app that allows users to plan a meal out by searching for weather and a listing of restaurants based on the input search location and the use of 2 separate APIs.",
