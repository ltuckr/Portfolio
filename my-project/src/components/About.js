      ...
      <div className="container mx-auto grid md:grid-cols-2 items-center justify-center md:justify-between">
        <div className="about-info">
          ...
          <p className="pb-5">
            ...
            I'm currently looking for full-time employment in web dev, and the opportunity to flex my creative muscles. 
             Making things look good is my happy place.
            I have a certificate from the University of North Carolina at Charlotte in Fullstack Development, 
            and a BFA in commercial photography from The Art Institute of Charlotte. 
